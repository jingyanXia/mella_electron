...
export default class EditPetInfo extends Component {
  ...
  _getPetInfo = () => {
    ...
    fetchRequest('/pet/getPetInfoByPatientIdAndPetId', 'POST', datas)
      .then(res => {
        ...
        if (res.flag === true) {
          //有宠物，进入1
          let { petId, petName, lastName, firstName, breedName, isMix, birthday, weight, url, gender } = res.data[0]
  ...
  _petSpecies = () => {
    ...
    switch (petSpecies) {
      case 1: dogbgc = '#E1206D'; catbgc = '#F08FB6'; hoursebgc = '#F08FB6'; rabbitbgc = '#F08FB6'; break;
      case 2: dogbgc = '#F08FB6'; catbgc = '#E1206D'; hoursebgc = '#F08FB6'; rabbitbgc = '#F08FB6'; break;
            ...
            <ul>
              <li >
                <div className='speciesChild' >
                  <div className='dog' onClick={() => { this.setState({ petSpecies: 1 }) }} style={{ backgroundColor: dogbgc }}>
              ...
              <li >
                <div className='speciesChild' >
                  <div className='dog' onClick={() => { this.setState({ petSpecies: 2 }) }} style={{ backgroundColor: catbgc }} >
              ...
              <li >
                <div className='speciesChild' >
                  <div className='dog' onClick={() => { this.setState({ petSpecies: 3 }) }} style={{ backgroundColor: hoursebgc }}>
              ...
              <li >
                <div className='speciesChild' >
                  <div className='dog' onClick={() => { this.setState({ petSpecies: 4 }) }} style={{ backgroundColor: rabbitbgc }}>
        ...
        <div className="r">
          <div className="img">
            <div className="ciral" onClick={() => {
              ...
              <img src={this.avatar} alt="" id="touxiang" width="80px" />
              <input type="file" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg" className="uploadImg" id="f" onChange={(e) => {
                ...
                reader.onload = (data) => {
                  ...
                  fetch('http://ec2-3-214-224-72.compute-1.amazonaws.com:8080/mellaserver/image/uploadImage', {
                    method: 'POST',
                    headers: {
                    },
                    body: formData
        ...
        <div className="editPetInfo_foot">
          <div className="save"
            onClick={() => {
              ...
              console.log(petName, birthday, firstName, lastName, petSpeciesBreedId, isMix, weight, gender);
              let data = null
              if (imageId === -1) {
                data = {
                  petName,
